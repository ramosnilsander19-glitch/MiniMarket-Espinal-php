...
<body>
    ...
    <div class="inicio-copy">
        <span class="inicio-etiqueta">Compra del dia a dia</span>
        <h2>Bebidas frias, picadera y lo basico para resolver rapido</h2>
        <p>
            En Minimarket Espinal encuentras refrescos, cerveza, snacks, arroz, aceite y productos de casa sin dar muchas vueltas.
        </p>
        ...
        <div class="inicio-resumen">
            <div class="inicio-dato">
                <strong>+20</strong>
                <span>Articulos listos para vender</span>
            </div>
            <div class="inicio-dato">
                <strong>De una vez</strong>
                <span>Compra agil y sin rodeos</span>
            </div>
            <div class="inicio-dato">
                <strong>Del barrio</strong>
                <span>Atencion cercana en Esperanza</span>
            </div>
        </div>
    </div>
    ...
    <div class="inicio-media">
        ...
        <div class="inicio-tarjeta-flotante">
            <h3>Lo que mas se mueve</h3>
            <p>Refrescos, cerveza, picadera y productos de casa para resolver la compra del dia.</p>
        </div>
    </div>
    </section>
    ...
    <div class="inicio-beneficio">
        <h3>Compra de diario</h3>
        <p>Una vitrina pensada para ver rapido lo esencial y pasar directo a comprar.</p>
    </div>

    <div class="inicio-beneficio">
        <h3>Precios visibles</h3>
        <p>Los productos muestran su precio claro para que el cliente compare sin esfuerzo.</p>
    </div>

    <div class="inicio-beneficio">
        <h3>Negocio local</h3>
        <p>Una presentacion mas cercana al colmado del barrio que a una pagina corporativa.</p>
    </div>
    </section>
...
<p class="destacados-texto">Arranca por algunos de los productos que mas salida tienen en la tienda.</p>
